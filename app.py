...
def main():
    # Title and description with Gen Z vibes
    ...
    st.markdown("<p class='subtitle'>Drop any photo and watch us work our digital magic ✨<br>Because sometimes you need to know where that cute coffee shop is, or... other reasons 👀</p>", unsafe_allow_html=True)
    
    # Fun Joe Goldberg inspired quote
    st.markdown('<p class="joe-quote">"You see, in a world full of digital footprints, every photo tells a story... and I\'m here to read between the pixels." 📸</p>', unsafe_allow_html=True)
